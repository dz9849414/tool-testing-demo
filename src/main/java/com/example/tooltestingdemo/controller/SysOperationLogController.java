    ...
    private void exportOperationLogs(List<SysOperationLog> logs, HttpServletResponse response, String fileName) throws IOException {
        ...
        try (XSSFWorkbook workbook = new XSSFWorkbook()) {
            ...
            String[] headers = {
                    ...
                    "用户代理", "状态", "错误信息", "执行时间(ms)", "创建时间", "方法调用链", "traceId"
            };
            int[] columnWidths = {36, 40, 20, 20, 20, 24, 20, 20, 36, 50, 18, 36, 12, 36, 18, 24, 80, 40};
            ...
            for (SysOperationLog log : logs) {
                ...
                setCellValue(row, 5, log.getModule(), dataStyle);
                ...
                setCellValue(row, 17, log.getTraceId(), dataStyle);
            }
