...
INSERT IGNORE INTO `pdm_tool_report_template` (`id`, `name`, `description`, `template_type`, `applicable_scene`, `template_structure`, `chapter_structure`, `content`, `style_config`, `is_system_template`, `is_public`, `related_business_type`, `usage_count`, `status`, `sort_order`, `preview_image`, `create_id`, `create_name`, `create_time`, `update_id`, `update_name`, `update_time`, `is_deleted`) VALUES (18, '日执行量标准模板', '小时级别执行量统计报告', 'DAILY_EXECUTION', NULL, '{\"sections\": [\"执行概览\", \"小时执行趋势\", \"执行峰值分析\", \"问题总结\", \"优化建议\"]}', '[{\"type\": \"text\", \"title\": \"执行概览\", \"dataSource\": \"OVERVIEW\"}, {\"type\": \"chart\", \"title\": \"小时执行趋势\", \"chartType\": \"LINE\", \"dataSource\": \"DAILY_EXECUTION\"}, {\"type\": \"chart\", \"title\": \"执行峰值分析\", \"chartType\": \"BAR\", \"dataSource\": \"DAILY_EXECUTION\"}, {\"type\": \"chart\", \"title\": \"问题总结\", \"chartType\": \"BAR\", \"dataSource\": \"FAILURE_REASONS\"}, {\"type\": \"text\", \"title\": \"优化建议\", \"dataSource\": \"OPTIMIZATION_SUGGESTIONS\"}]', NULL, '{}', 1, 1, NULL, 0, 1, 0, NULL, NULL, NULL, '2026-05-11 14:30:00', NULL, NULL, '2026-05-11 14:30:00', 0);
